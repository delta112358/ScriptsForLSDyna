...
def writeLoadCurve(loadFile, temperatureDifferenceCurve, roomTemperature, NodeNumber, timeVector):
    temperatureDifferenceCurve = [0] + [temperatureDifferenceCurve[0]] + [temperatureDifference for temperatureDifference in temperatureDifferenceCurve[1:] for _ in range(2)]
